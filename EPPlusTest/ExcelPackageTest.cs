    ...
    public class ExcelPackageTest : TestBase
    {
        ...
        public void TestExcelPackageEncryptionSupport()
        {
            ...
            try
            {
                ...
                try
                {
                    using (var package = new ExcelPackage(file, password: "WrongPassword", tempFolder: EPPlusTest.TempFolderHelper.Create()))
                    {
                ...
                using (var package = new ExcelPackage(file, password: "StrongPassword", tempFolder: EPPlusTest.TempFolderHelper.Create()))
                {
                    Assert.AreEqual(1, package.Workbook.Worksheets.Count);
