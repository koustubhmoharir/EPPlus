    ...
    public class ColumnarExportAndMapping : TestsBase
    {
        ...
        public static void Initialize(TestContext context)
        {
            SaveTemplate(template, package =>
            {
                ...
                options.Cells["A1"].Style.Font.Color.SetColor(ExcelColorValue.DarkBlue);
                options.Cells["A1"].Style.Fill.PatternType = ExcelFillStyle.Solid;
                options.Cells["A1"].Style.Fill.BackgroundColor.SetColor(ExcelColorValue.LightBlue);
                ...
                for (int col = 1; col <= 3; col++)
                {
                    ...
                    cell.Style.Fill.BackgroundColor.SetColor(ExcelColorValue.LightYellow);
                ...
                for (int col = 1; col <= 3; col++)
                {
                    ...
                    cell.Style.Font.Bold = true;
                    cell.Style.Fill.PatternType = ExcelFillStyle.Solid;
                    cell.Style.Fill.BackgroundColor.SetColor(ExcelColorValue.LightGray);
        ...
        public void HeaderFooterValuesStylesAndWidths()
        {
            ...
            }, package =>
            {
                ...
                Assert.AreEqual("FF00008B", dest.Cells["A1"].Style.Font.Color.Rgb); 
