...
namespace EPPlusE2ETest
{
    ...
    public class LargeDatasetExport : TestsBase
    {
        ...
        public async Task ExportSheetMemoryPeakTest()
        {
            ...
            string outputName = "LargeDatasetExport.MemoryPeakTest1.xlsx";
        ...
        public async Task ExportSheetHeavyDataPerformanceTest()
        {
            ...
            string outputName = "LargeDatasetExport.HeavyDataPerformanceTest1.xlsx";
            string outputPath = Path.Combine(OutputsDirectory, outputName);
            if (File.Exists(outputPath))
            {
                File.Delete(outputPath);
        ...
        private void PopulateHeavySheet(ExcelWorksheet ws, int rowCount)
        {
            ...
            for (int col = 1; col <= 20; col++)
            {
                ...
                cell.Style.Fill.BackgroundColor.SetColor(System.Drawing.ColorTranslator.FromHtml("#366092"));
                cell.Style.Font.Color.SetColor(System.Drawing.ColorTranslator.FromHtml("#FFFFFF"));
            ...
            for (int i = 2; i <= rowCount + 1; i++)
            {
                ...
                rowRange.Style.Border.Bottom.Color.SetColor(System.Drawing.ColorTranslator.FromHtml("#D9D9D9"));

                if (i % 2 == 0)
                {
                    rowRange.Style.Fill.PatternType = ExcelFillStyle.Solid;
                    rowRange.Style.Fill.BackgroundColor.SetColor(System.Drawing.ColorTranslator.FromHtml("#F2F5F9"));
                }
            }
        }
    }
