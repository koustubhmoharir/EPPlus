...
namespace OfficeOpenXml.ConditionalFormatting
{
    ...
    internal static class ExcelConditionalFormattingConstants
    {
        ...
        {
            internal static readonly ExcelColorValue CfvoLowValue = ExcelColorValue.FromArgb(0xFF, 0xF8, 0x69, 0x6B);
            internal static readonly ExcelColorValue CfvoMiddleValue = ExcelColorValue.FromArgb(0xFF, 0xFF, 0xEB, 0x84);
            internal static readonly ExcelColorValue CfvoHighValue = ExcelColorValue.FromArgb(0xFF, 0x63, 0xBE, 0x7B);
        }
        #endregion Colors
    }
}
